...
| `lib_gpu_owners.ps1` | Разбор владельцев GPU: правило ONE HEAVY GPU OWNER и не отнесённая VRAM, подключается диагностикой | Нет |
| `lib_task_results.ps1` | Разбор кодов Task Scheduler: отделяет отказы задач от состояний планировщика | Нет |
