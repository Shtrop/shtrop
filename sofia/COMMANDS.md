...
| `power_limit_unsettled` | окно кончилось сразу после перезагрузки: карта уже на другом лимите, и он ещё не подтверждён наблюдением — снимается продолжением окна |
